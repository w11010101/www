      ...
      if (
        ...
        //target 拖拽的父节点是根节点 rootEl 
          ...
          var targetRect = target.getBoundingClientRect(), //目标节点的rect
            ...
            floating = /left|right|inline|inlineBlock/.test(lastCSS.cssFloat + lastCSS.display) || (lastParentCSS.display == 'flex' && lastParentCSS['flex-direction'].indexOf('row') === 0),
    ...
    if (el) {
      ...
      do {
        ...
        if (
          ...
          (selector === '>*' && el.parentNode === ctx) || _matches(el, selector)
        ) {
